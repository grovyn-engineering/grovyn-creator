...
/**
 * Thrown on a bad configuration. Carries the formatted report so the process
 * entry point can print it and exit non-zero without a stack trace, which is
 * noise when the problem is a missing variable.
 */
