 ...
 * ahead of the app.
 */
// From environment-error.js, not env.js: importing env.js here would run its
// validation during module evaluation, and the throw would escape as an
// uncaught exception before `main().catch()` below could turn it into a
// readable report. env.js is loaded dynamically inside main() instead.
